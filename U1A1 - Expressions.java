public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println((9 % 4) - 8 + 8 / 8 + (Math.sqrt(81) / 3));
        System.out.println((9 % 4) - 8 + 8 / 8 + (9 / 3));
        System.out.println((9 % 4) - 8 + 8 / 8 + 3);
        ...
        System.out.println(((14 / 2 + 3) * 0.85 + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println(((7 + 3) * 0.85 + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((10 * 0.85 + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println((8.5 + 2) - Math.pow(Math.sqrt(25), 3));
        System.out.println(10.5 - Math.pow(Math.sqrt(25), 3));
        System.out.println(10.5 - Math.pow(5, 3));
